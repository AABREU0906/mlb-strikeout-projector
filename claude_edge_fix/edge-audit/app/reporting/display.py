...
def print_market_comparison(
    ...
    *,
    ...
    edge_analysis = analyze_betting_edge(
        ...
        # fixes). statistics_only_projection is used rather than
        # final_blended_projection because it's the model's own,
        # uncontaminated view -- the blended figure already leans partly
        # toward the market price itself, which would make this a
        # circular "the market agrees with the market" check.
        projection_value=result.statistics_only_projection,
        line_value=line,
