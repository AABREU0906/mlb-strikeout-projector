...
class CachedResponse:
    ...
    from_cache: bool
    retrieved_at: str
    headers: dict = None  # response headers from a LIVE fetch (empty/None on a cache hit) -- added for The Odds API credit-usage headers; no existing caller reads this, so it's purely additive
